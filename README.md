...
- The latest release
- A Windows file, such as `.exe` or `.zip`
- The file that matches your PC
...
2. Download the Windows file from the GitHub page.
...
4. Start with the standard mode before changing advanced options.
5. Run a small test task first.
...
2. Download the MoDA release file.
3. Extract the zip file.
4. Open the MoDA folder.
5. Double-click the app.
6. Use the default settings.
7. Run a small test job.
...
- **Executable file**: A file that starts the app, often ending in `.exe`
- **GPU**: The part of your PC that helps with graphics and compute work
